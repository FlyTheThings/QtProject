...
void cfgWidget::initButtonGroup()
{
...
void cfgWidget::slot_sliderCOL(int value)
{
    ui->label_AUTO_COL->setText(QString::number(value));
}

void cfgWidget::slot_sliderRUD(int value)
{
    ui->label_AUTO_RUD->setText(QString::number(value));
}

void cfgWidget::slot_sliderPHI2AIL(int value)
{
    ui->label_PHI2AIL->setText(QString::number(value));
}

void cfgWidget::slot_sliderTHETA2ELE(int value)
{
    ui->label_THETA2ELE->setText(QString::number(value));
}

void cfgWidget::slot_sliderVX2ELE(int value)
{
    ui->label_VX2ELE->setText(QString::number(value));
}

void cfgWidget::slot_sliderVY2AIL(int value)
{
    ui->label_VY2AIL->setText(QString::number(value));
}

void cfgWidget::slot_cmdButtonClicked(int ButtonID)
{
    quint8  Data[10];
    int     tmpI;
    float   tmpF;
...
void cfgWidget::echoMessagePacket(datalink_message_t *msg)
{
    quint8 echoMsg;
    quint8 tmpData[12];
...
void cfgWidget::autoCmdEchoOk(quint8 x, quint8 *data)
{
    QString tmpS;
    float   tmpF;
    int     tmpI;
