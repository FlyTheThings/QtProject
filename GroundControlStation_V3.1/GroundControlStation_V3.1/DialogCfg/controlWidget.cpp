...
void QControlWidget::selectcontrol(int index)
{
    switch(index) {
...
void QControlWidget::initButtonGroupEle(void)
{
...
void QControlWidget::initButtonGroupAil(void)
{
...
void QControlWidget::initButtonGroupCol(void)
{
...
void QControlWidget::initButtonGroupRud(void)
{
...
void QControlWidget::slot_cmdEleButtonClicked(int ButtonID)
{
    quint8   Data[12];
    float    tmpF;
...
void QControlWidget::slot_cmdAilButtonClicked(int ButtonID)
{
    quint8   Data[12];
    float    tmpF;
...
void QControlWidget::slot_cmdColButtonClicked(int ButtonID)
{
    quint8   Data[12];
    float    tmpF;
...
void QControlWidget::slot_cmdRudButtonClicked(int ButtonID)
{
    quint8   Data[12];
    float    tmpF;
...
void QControlWidget::echoMessagePacket(datalink_message_t *msg)
{
    quint8 echoMsg;
    float  tmpF;
