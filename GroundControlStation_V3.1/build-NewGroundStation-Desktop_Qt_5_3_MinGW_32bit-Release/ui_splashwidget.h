...
public:
    ...
    void setupUi(QWidget *QSplashWidget)
    {
        if (QSplashWidget->objectName().isEmpty())
            QSplashWidget->setObjectName(QStringLiteral("QSplashWidget"));
        QSplashWidget->resize(811, 598);
        groupBox_99 = new QGroupBox(QSplashWidget);
        groupBox_99->setObjectName(QStringLiteral("groupBox_99"));
        groupBox_99->setGeometry(QRect(130, 250, 551, 171));
        ...
        gridLayout_31->addWidget(label_286, 2, 0, 1, 1);
        ...
        gridLayout_31->addWidget(lineEdit_SPRAY_LOW_V, 2, 1, 1, 3);
        ...
        gridLayout_31->addWidget(label_SPRAYI, 4, 0, 1, 1);
        ...
        gridLayout_31->addWidget(doubleSpinBox_SPRAYP, 3, 1, 1, 3);
        ...
        gridLayout_31->addWidget(doubleSpinBox_SPRAYI, 4, 1, 1, 3);

        groupBox_39 = new QGroupBox(QSplashWidget);
        groupBox_39->setObjectName(QStringLiteral("groupBox_39"));
        groupBox_39->setGeometry(QRect(130, 20, 551, 162));
        ...
        retranslateUi(QSplashWidget);

        QMetaObject::connectSlotsByName(QSplashWidget);
    } // setupUi

    void retranslateUi(QWidget *QSplashWidget)
    {
        QSplashWidget->setWindowTitle(QApplication::translate("QSplashWidget", "Form", 0));
        groupBox_99->setTitle(QApplication::translate("QSplashWidget", "\346\216\247\345\210\266\350\256\276\345\256\232", 0));
        label_288->setText(QApplication::translate("QSplashWidget", "\347\261\263", 0));
        label_289->setText(QApplication::translate("QSplashWidget", "\347\261\263/\347\247\222", 0));
        label_SPRAYP->setText(QApplication::translate("QSplashWidget", "  \346\257\224\344\276\213\357\274\232", 0));
        label_285->setText(QApplication::translate("QSplashWidget", "  \350\215\257\351\207\217\357\274\232", 0));
        pushButton_SPRAYSET->setText(QApplication::translate("QSplashWidget", "\350\256\276\347\275\256", 0));
        pushButton_SPRAYASK->setText(QApplication::translate("QSplashWidget", "\346\237\245\350\257\242", 0));
        label_286->setText(QApplication::translate("QSplashWidget", "\346\234\200\344\275\216\351\200\237\357\274\232", 0));
        lineEdit_SPRAY_RANGE->setText(QApplication::translate("QSplashWidget", "N/A", 0));
        lineEdit_SPRAY_LOW_V->setText(QApplication::translate("QSplashWidget", "N/A", 0));
        label_287->setText(QApplication::translate("QSplashWidget", "\346\257\253\345\215\207/\344\272\251", 0));
        label_152->setText(QApplication::translate("QSplashWidget", "  \345\226\267\345\271\205\357\274\232", 0));
        lineEdit_SPRAY_AVE->setText(QApplication::translate("QSplashWidget", "N/A", 0));
        label_SPRAYI->setText(QApplication::translate("QSplashWidget", "  \347\247\257\345\210\206\357\274\232", 0));
        groupBox_39->setTitle(QApplication::translate("QSplashWidget", "\345\226\267\346\264\222\347\263\273\347\273\237\346\265\213\350\257\225", 0));
        pushButton_SPRAY_VSET->setText(QApplication::translate("QSplashWidget", "\346\237\245\350\257\242", 0));
        label_142->setText(QApplication::translate("QSplashWidget", "  \350\276\223\345\205\245\357\274\232", 0));
        progressBar_SPRAY_INPUT->setFormat(QApplication::translate("QSplashWidget", "%v", 0));
        label_143->setText(QApplication::translate("QSplashWidget", "  \350\276\223\345\207\272\357\274\232", 0));
        progressBar_SPRAY_OUTPUT->setFormat(QApplication::translate("QSplashWidget", "%v", 0));
        label_145->setText(QApplication::translate("QSplashWidget", "\345\275\223\345\211\215\346\250\241\345\274\217\357\274\232", 0));
        lineEdit_SPRAY_MODE->setText(QApplication::translate("QSplashWidget", "N/A", 0));
        label_148->setText(QApplication::translate("QSplashWidget", "\345\275\223\345\211\215\351\200\237\345\272\246\357\274\232", 0));
        lineEdit_SPRAY_V->setText(QApplication::translate("QSplashWidget", "N/A", 0));
        label_150->setText(QApplication::translate("QSplashWidget", "\347\261\263/\347\247\222", 0));
        label_146->setText(QApplication::translate("QSplashWidget", "\351\200\237\345\272\246\350\256\276\345\256\232\357\274\232", 0));
        lineEdit_SPRAY_VSET->setText(QApplication::translate("QSplashWidget", "N/A", 0));
        label_149->setText(QApplication::translate("QSplashWidget", "\345\275\223\345\211\215\346\265\201\351\207\217\357\274\232", 0));
        lineEdit_SPRAY_FLOW->setText(QApplication::translate("QSplashWidget", "N/A", 0));
        label_151->setText(QApplication::translate("QSplashWidget", "\346\257\253\345\215\207/\347\247\222", 0));
        label_144->setText(QApplication::translate("QSplashWidget", "\346\250\241\345\274\217\351\200\211\346\213\251\357\274\232", 0));
        label_147->setText(QApplication::translate("QSplashWidget", "\347\261\263/\347\247\222", 0));
        pushButton_SPRAY_RUNMODE->setText(QApplication::translate("QSplashWidget", "\350\277\220\350\241\214\346\250\241\345\274\217", 0));
        pushButton_SPRAY_TESTMODE->setText(QApplication::translate("QSplashWidget", "\346\265\213\350\257\225\346\250\241\345\274\217", 0));
    } // retranslateUi

};

namespace Ui {
    class QSplashWidget: public Ui_QSplashWidget {};
} // namespace Ui
