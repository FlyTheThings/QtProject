/****************************************************************************
** Meta object code from reading C++ file 'selfflywidget.h'
**
...
#include "../../GroundControlStation_V3.1/DialogCfg/selfflywidget.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'selfflywidget.h' doesn't include <QObject>."
...
struct qt_meta_stringdata_QSelfflyWidget_t {
    QByteArrayData data[18];
    char stringdata[223];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QSelfflyWidget_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QSelfflyWidget_t qt_meta_stringdata_QSelfflyWidget = {
    {
...
static const uint qt_meta_data_QSelfflyWidget[] = {
...
void QSelfflyWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        QSelfflyWidget *_t = static_cast<QSelfflyWidget *>(_o);
        switch (_id) {
        ...
        {
            typedef void (QSelfflyWidget::*_t)(quint8 , quint8 , quint8 , const quint8 * , quint8 );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QSelfflyWidget::signal_cmdOutput)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject QSelfflyWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QSelfflyWidget.data,
      qt_meta_data_QSelfflyWidget,  qt_static_metacall, 0, 0}
};


const QMetaObject *QSelfflyWidget::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *QSelfflyWidget::qt_metacast(const char *_clname)
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QSelfflyWidget.stringdata))
        return static_cast<void*>(const_cast< QSelfflyWidget*>(this));
    return QWidget::qt_metacast(_clname);
}

int QSelfflyWidget::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
...
// SIGNAL 0
void QSelfflyWidget::signal_cmdOutput(quint8 _t1, quint8 _t2, quint8 _t3, const quint8 * _t4, quint8 _t5)
{
