...
public:
    ...
    void setupUi(QWidget *simDrone)
    {
        ...
        send_heartbeat = new QPushButton(simDrone);
        send_heartbeat->setObjectName(QStringLiteral("send_heartbeat"));
        send_heartbeat->setGeometry(QRect(9, 215, 75, 23));
    ...
    void retranslateUi(QWidget *simDrone)
    {
        ...
        send_heartbeat->setText(QApplication::translate("simDrone", "\345\217\221\351\200\201\346\225\260\346\215\256", 0));
    } // retranslateUi
